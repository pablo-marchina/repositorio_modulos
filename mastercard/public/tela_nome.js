class TelaNome extends Phaser.Scene {
    ...
    create() {
        ...
        this.scale.on('resize', () => {
            const newBounds = this.game.canvas.getBoundingClientRect();
            this.inputNome.style.left = (newBounds.left + posXcentro - 120) + "px";
            this.inputNome.style.top = (newBounds.top + posYinput) + "px";
        });
