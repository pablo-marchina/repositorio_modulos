// Overlay de parabéns exibido ao concluir todas as ilhas da trilha Avançada.
// É iniciado como cena independente e encaminha o jogador para o fluxo
// do Mastercard Surpreenda como recompensa final.
class TelaParabens3 extends Phaser.Scene {
    ...
    create() {
        ...
        // Subtítulo indica a conclusão total do jogo
        ...
        // Texto comemorativo de conclusão total da jornada
        ...
        // Mini card que exibe a recompensa conquistada
        ...
        // Label de status — usa "CONQUISTADO" em vez de "DESBLOQUEADO" para diferenciar a recompensa final
        ...
        // Nome da recompensa final (teaser para o código Surpreenda)
        ...
        // Ao confirmar: micro-animação de "aperto" antes de encaminhar ao fluxo do Surpreenda
        btnHit.on('pointerdown', () => {
            this.tweens.add({
                ...
                yoyo: true,
                onComplete: () => {
                    // Para esta cena e a trilha avançada antes de iniciar o fluxo do Surpreenda
                    this.scene.stop();
        ...
        // Para apenas esta cena sobreposição; a TelaTrilhaAvancada ao fundo continua ativa
